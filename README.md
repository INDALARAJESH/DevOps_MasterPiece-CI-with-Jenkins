...
![](https://github.com/indalarajesh/DevOps_MasterPiece-CI-with-Jenkins/blob/main/images/pipeline.png)
## Pipeline flow:
...
![](https://github.com/indalarajesh/DevOps_MasterPiece-CI-with-Jenkins/blob/main/images/Screenshot%20from%202023-06-23%2022-45-05.png)
...
1. Installation guide is available here  https://github.com/indalarajesh/DevSecOps-project/blob/main/Jenkins_installation.md
...
![](https://github.com/indalarajesh/DevSecOps-project/blob/main/Images/jenkins.png) 
...
To create EKS Cluster using Terraform, I have put the Terraform code here - https://github.com/indalarajesh/medicure-project/tree/master/eks_module
...
![](https://github.com/indalarajesh/DevOps_MasterPiece-CI-with-Jenkins/blob/main/images/sonarqube-.png)
2.  create a project manually, give some name to project, project key
![](https://github.com/indalarajesh/DevSecOps-project/blob/main/Images/sonarqubedb.png) 
3. click on setup
4. click on other ci 
...
7. select the project type, in this case, I used Maven
 ![](https://github.com/indalarajesh/DevSecOps-project/blob/main/Images/soanr.png)  
...
1.  create a new Quality Gate according to your conditions
 ![](https://github.com/indalarajesh/DevSecOps-project/blob/main/Images/quality%20gate.png)
3.  click on Projects > click on all > select your project
![](https://github.com/indalarajesh/DevSecOps-project/blob/main/Images/qualiygate.png   )
4. set as default
...
![](https://github.com/indalarajesh/DevSecOps-project/blob/main/Images/webhook.png)
...
![](https://github.com/indalarajesh/DevSecOps-project/blob/main/Images/dockerhub.png)
2. click on sign up
...
![](https://github.com/indalarajesh/DevSecOps-project/blob/main/Images/slack.png)
...
![](https://github.com/indalarajesh/DevSecOps-project/blob/main/Images/approleVault.png) 
...
1. now to  Manage  Jenkins  >  configure system/system>  search for Slack
 ![](https://github.com/indalarajesh/DevSecOps-project/blob/main/Images/slcakws.png)
...
#### Find the whole pipeline here
 https://github.com/indalarajesh/DevOps_MasterPiece-CI-with-Jenkins/blob/main/Jenkinsfile
...
![](https://github.com/indalarajesh/DevOps_MasterPiece-CI-with-Jenkins/blob/main/images/jenkins.png)
...
![](https://github.com/indalarajesh/DevOps_MasterPiece-CI-with-Jenkins/blob/main/images/quality-gate.png)

### Trivy report in AWS S3 push by jenkins
![](https://github.com/indalarajesh/DevOps_MasterPiece-CI-with-Jenkins/blob/main/images/trivy-report.png) 


### Trivy report 
![](https://github.com/indalarajesh/DevOps_MasterPiece-CI-with-Jenkins/blob/main/images/Screenshot%20from%202023-06-23%2023-59-22.png)


### Images in DockerHub pushed by jenkins 
![](https://github.com/indalarajesh/DevOps_MasterPiece-CI-with-Jenkins/blob/main/images/dockerhub.png)

### Image tag updated by jenkins and push changes to feature branch
![](https://github.com/indalarajesh/DevOps_MasterPiece-CI-with-Jenkins/blob/main/images/Screenshot%20from%202023-06-24%2000-06-51.png) 

### Pull Request created by jenkins in DevOps_MasterPiece-CD-with-argocd GitHub repo
![](https://github.com/indalarajesh/DevOps_MasterPiece-CI-with-Jenkins/blob/main/images/pr.png)

### App in ArgoCD  
![](https://github.com/indalarajesh/DevOps_MasterPiece-CI-with-Jenkins/blob/main/images/argocd.png)


### Application output deployed in EKS Cluster by ArgoCD 
![](https://github.com/indalarajesh/DevOps_MasterPiece-CI-with-Jenkins/blob/main/images/Screenshot%20from%202023-06-22%2023-24-29.png)

### Slack output of jenkins
![](https://github.com/indalarajesh/DevOps_MasterPiece-CI-with-Jenkins/blob/main/images/Screenshot%20from%202023-06-22%2023-24-05.png)

### Slack output of ArgoCD
![](https://github.com/indalarajesh/DevOps_MasterPiece-CI-with-Jenkins/blob/main/images/Screenshot%20from%202023-06-22%2023-58-34.png)

### Prometheus  
![](https://github.com/indalarajesh/DevOps_MasterPiece-CI-with-Jenkins/blob/main/images/Screenshot%20from%202023-06-22%2023-20-00.png)

### Grafana  
![](https://github.com/indalarajesh/DevOps_MasterPiece-CI-with-Jenkins/blob/main/images/Screenshot%20from%202023-06-22%2023-19-50.png)
